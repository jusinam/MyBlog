...
class BlogTest(unittest.TestCase):
    def setUp(self):
        self.user_kenya = User(username="Kenya",password="ugali",email="kenya@gmail.com")
        self.new_blog = Blog(id="1",title="testing",content="testing blog",user_id=self.user_kenya)
    def tearDown(self):
        Blog.query.delete()
        User.query.delete()
    ...
    def test_check_instance(self):
        ...
        self.assertEquals(self.new_blog.user_id,self.user_kenya)
...
class CommentTest(unittest.TestCase):
    def setUp(self):
        self.user_kenya = User(username= 'Kenya',email='kenya@gmail.com',password = 'ugali')
    ...
    def test_check_instance(self):
        ...
        self.assertEquals(self.new_comment.user_id,self.user_kenya)
